...
#curl -u $SAUCE_USERNAME:$SAUCE_ACCESS_KEY -X POST -H "Content-Type: application/octet-stream" https://saucelabs.com/rest/v1/storage/$SAUCE_USERNAME/sample-app-ios-sim.zip?overwrite=true --data-binary @../apps/iOS.Simulator.SauceLabs.Mobile.Sample.app.2.3.0.zip
...
curl -u $SAUCE_USERNAME:$SAUCE_ACCESS_KEY -X POST -H "Content-Type: application/octet-stream" https://eu-central-1.saucelabs.com/rest/v1/storage/$SAUCE_USERNAME/sample-app-ios-sim.zip?overwrite=true --data-binary @../apps/iOS.Simulator.SauceLabs.Mobile.Sample.app.2.3.0.zip
