...
exports.config = {
    ...
    before: () => {
        ...
        /**
         * Custom property that is used to determine if biometric access is already allowed. iOS asks you this the
         * first time you start a test on a `clean` device / simulator.
         */
