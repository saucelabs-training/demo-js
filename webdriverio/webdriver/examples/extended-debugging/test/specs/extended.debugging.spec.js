describe('LoginPage and Sauce extendedDebugging API', () => {
    ...
    it('should be able to throttle the network by setting it to offline', async () => {
        ...
        try {
            ...
            await expect(await $('#login_button_container').waitForDisplayed({reverse: true})).toEqual(
                true,
            ...
            await expect(message).toContain('unknown error: net::ERR_INTERNET_DISCONNECTED');
        }
    });
